                                        ...
                                        selectedOption.value === 'Status' ? (
                                          ...
                                          selectedOption.value === 'cpf' ? (
                                            <div>
                                              ...
                                              <Input icon={<IconUser size={16} />} type="number" placeholder="Digite o CPF ou CNPJ" maxLength={14} onChange={(e) => setCpf(e.target.value)} />
                                            </div>
                                          ) :
                                            selectedOption.value === 'email' ? (
                                              <div>
                                                ...
                                                <Input icon={<IconMail size={16} />} type="text" placeholder="Digite o email" onChange={(e) => setEmail(e.target.value)} />
                                              </div>
                                            ) :
