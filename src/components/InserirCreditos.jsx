          ...
          <Tabs.Panel value="Meios de pagamento" pt="xs">
            <Card shadow="sm" padding="lg" radius="md" withBorder>
                  ...
                  <>
                    <Group position="apart" className="d-block">
                      <div
                        ...
                        onClick={() => {
                          setMetodo("cartaoDeb");
                          localStorage.setItem("tipoCard", "debito");
                        }}
                      >
                        <BsCreditCard2Back
                          className="mx-1"
                    ...
                    <Group position="apart" className="d-block">
                      <div
                        ...
                        onClick={() => {
                          setMetodo("cartaoCred");
                          localStorage.setItem("tipoCard", "credito");
                        }}
                      >
                        <BsCreditCard2Front
                          className="mx-1"
              ...
              <Group position="center"  mt="md" mb="xs">
                  <Text fs={1} weight={400} color="gray" id="modalTexto"> 
                     Pagamento com cartão de crédito ou débito indisponível no momento.
                  </Text>
                </Group>
              ) : null}
              ...
              {metodo !== "pix" && creditCard.length > 0  && 1 === 2 ? (
                <div>
