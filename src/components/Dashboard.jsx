                    ...
                    <div class="card bg-yellow-100 border-0 shadow">
                        <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                            ...
                            <div class="d-flex ms-auto">
                                <button class="btn4 botao btn-sm btn-ghost-secondary me-3" type="button"> Mês </button>
                                <button class="btn4 botao btn-sm btn-ghost-secondary me-2" type="button"> Semana </button>
                            </div>
                        </div>
                        <div class="card-body4 p-2">
                                    ...
                                    <div class="row align-items-center mb-4">
                                        ...
                                        <div class="col">
                                            <div class="progress-wrapper">
                                                ...
                                                <div class="progress mb-0">
                                                    <div class="progress-bar bg-success w-50" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-center mb-4">
                                        ...
                                        <div class="col">
                                            <div class="progress-wrapper">
                                                ...
                                                <div class="progress mb-0">
                                                    <div class="progress-bar bg-warning w-50" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col">
                                            <div class="progress-wrapper">
                                                ...
                                                <div class="progress mb-0">
                                                    <div class="progress-bar bg-danger w-50" role="progressbar" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
