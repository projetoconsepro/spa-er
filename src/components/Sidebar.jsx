         ...
         <nav className="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none bg-blue-50">
            ...
            {mostrarSidebar ? <nav id="sidebarMenu" className="sidebar d-lg-block bg-blue-50 text-white collapse" data-simplebar> 
                ...
                <ul className="nav flex-column pt-md-0 ">
                    ...
                    {links.map((link, key) => (<a key={key} className={link.className} onClick={() => componentefunc(link.componente)}>{link.icon}{link.name}</a>))}
                    </li>
                </ul>
            </div>
            </nav> : null}
                    ...
                    <ul className="navbar-nav align-items-center">
                        <li className="nav-item dropdown ms-lg-3">
                            ...
                            <div className="media d-flex align-items-center">
                                <img className="avatar rounded-circle" alt="Image placeholder" src="assets/img/img_avatar.png" />
