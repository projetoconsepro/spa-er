...
const Confirmation = () => {
  ...
  const reenviarCodigo = async (e) => {
    ...
    veiculo
      .get(`/codigo-recuperacao-senha?email=${email}`)
      .then((response) => {
        const resposta = response.data.msg.resultado;
        if (resposta === false) {
          setMensagem(response.data.msg.msg);
    ...
    <section className="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
      <div className="container">
            ...
            <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
              ...
              <Group position="left">
                <p
                  ...
                  style={{ cursor: "pointer", color: "#3A58C8" }}
                  onClick={reenviarCodigo}
                >
                  <small>
                    <u>Clique para reenviar</u>
                  </small>
                </p>
              </Group>
              <Group position="left">
        ...
        >
          ...
          <div className="mt-4">
            <div style={{ display: "flex", alignItems: "center" }}>
              <FiMap size={20} style={{ marginRight: "5px", color: "blue" }} />
              <span>Endereço</span>
            </div>
          </div>
