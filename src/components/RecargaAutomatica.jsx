...
import { Group, Text, Button, Image, Box } from "@mantine/core";
...
const RecargaAutomatica = () => {
    ...
    const handleToggle = () => setRecargaAtivada(!recargaAtivada);
  ...
  const handleValorRecargaClose = () => {
    ...
    return (
        <div><div className="container p-0 d-flex justify-content-center">
            <div>
                    ...
                    <div className="align-items-center pb-3">
                        <div className='text-start mt-2'>
                            ...
                            <p className=".h5">
                                ...
                                uma recarga com seu cartão de crédito.</p>
                        </div>
                        <div className='mt-4'>
                            <div className='div-saldo py-3' style={{
